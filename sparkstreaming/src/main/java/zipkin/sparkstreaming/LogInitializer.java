...
@AutoValue
abstract class LogInitializer implements Serializable, Runnable {
  ...
  static Runnable create(String zipkinLogLevel) {
    ...
    return new AutoValue_LogInitializer(log4Jlevel, julLevel);
  }

  abstract Level log4Jlevel();

  abstract java.util.logging.Level julLevel();
